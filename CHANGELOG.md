...
## Unreleased — targeting 0.1.0rc1

These changes are assigned to a candidate that is still in preparation. They
have **not been published or tagged**. Immediately before an actual release,
the release commit must change this heading to `## 0.1.0rc1 — YYYY-MM-DD` and
remove this preparation note; the signed tag and GitHub prerelease are the
